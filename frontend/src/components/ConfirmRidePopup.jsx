  ...
  <input type="text" />
       ...
       <div className="mt-6 w-full ">
         <form  onSubmit={(e)=>{
          ...
          }} className="bg-[#eee] px-6 py-4 font-mono text-base w-full rounded-lg mt-5 " type="text" placeholder="Enter OTP" />
        ...
        <button
          ...
          className="w-full mt-1 bg-red-600  text-semibold p-2 rounded  text-white"
        >
          cancel Ride
        </button>
         </form>
